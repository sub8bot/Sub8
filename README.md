...
| Platform | Artifact |
|---|---|
| macOS (Apple Silicon) | `OctoBot-0.2.0-mac-arm64.dmg` — signed and notarized |
| macOS (Intel) | `OctoBot-0.2.0-mac-x64.dmg` — signed and notarized |
| Windows | `OctoBot-0.2.0-win-x64.zip` |
| Linux | `OctoBot-0.2.0-linux-x86_64.AppImage` or `OctoBot-0.2.0-linux-x64.tar.gz` |
